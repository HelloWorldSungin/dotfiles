...
const CHEATSHEET_DATA: VimCommand[] = [
  ...
  { key: "Space ud", desc: "Toggle window diffing side-by-side (diffthis/diffoff)", category: "advanced", subcategory: "Git & Diff", keywords: ["diff", "toggle", "windows", "side-by-side", "compare", "space"] },
