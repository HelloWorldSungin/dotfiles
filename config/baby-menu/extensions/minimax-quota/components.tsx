...
import { refreshMiniMaxQuota, useMiniMaxQuotaState, type QuotaWindow } from "./store";
...
export function MiniMaxQuotaView() {
  const state = useMiniMaxQuotaState();

  useEffect(() => {
    void refreshMiniMaxQuota();
  }, []);

  let weeklyWindow: QuotaWindow | undefined;
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between text-xxs uppercase tracking-caps text-ink-label border-t border-line-faint/10 pt-2 mt-1">
            ...
            <div className="flex items-center gap-1.5 font-mono">
              ...
              <button
                type="button"
                onClick={() => void refreshMiniMaxQuota()}
